...
const READ_ALL = [ROLES.AURA_ROOT, ROLES.SITE_ADMIN, ROLES.AURA_SUPPORT, ROLES.AURA_SUPPORT, ROLES.SITE_STAFF];
const EDIT_ACCESS = [ROLES.AURA_ROOT, ROLES.SITE_ADMIN, ROLES.AURA_SUPPORT];
...
router.post("/import", verifyRole([ROLES.AURA_ROOT, ROLES.SITE_ADMIN]), upload.single("file"), staffController.importStaff);
